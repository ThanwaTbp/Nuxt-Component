			...
			<v-row>
				<v-col cols="12" md="7" lg="6" class="d-block d-lg-flex align-center">
					<div class="text-center text-md-left">
						...
						<div class="mt-8 pt-2">
							<v-btn color="success" class="btn-custom-lg" target="_blank"
								href="https://www.itgenius.co.th" elevation="0">
								เริ่มต้นใช้งาน
							</v-btn>
						</div>
					</div>
			...
			<v-row justify="center">
              ...
              ">
						...
						<div class="mt-16 pt-2">
							<v-btn nuxt large rounded to="/" class="btn-custom-md" depressed elevation="0">
								Do you Need Help ?
							</v-btn>
						</div>
					</div>
