						...
						<form>
							<v-row class="mt-15">
								<v-col cols="12" md="6" class="py-0 pl-0">
									<v-text-field label="Name" outlined v-model="data.name"
										placeholder="Name"></v-text-field>
								</v-col>
								<v-col cols="12" md="6" class="py-0 pl-0">
									<v-text-field label="Email" outlined type="email" v-model="data.email"
							...
							<v-btn nuxt to="/contact" class="btn-custom-md btn-danger-gradient" outlined color="error"
								elevation="0">
								ส่งข้อมูล
							</v-btn>
						</form>
